...
import com.lovezc.forever.entity.ExceptionLog;
import com.lovezc.forever.entity.OperationLog;
...
//    private String operVer;
     ...
     */
    @Pointcut("@annotation(com.lovezc.forever.config.OperLog)")
     ...
     */
    @Pointcut("execution(* com.lovezc.forever.controller..*.*(..))")
    ...
    public void saveOperLog(JoinPoint joinPoint, Object keys) {
        ...
        try {
            ...
            System.out.println("打印日志------------" + operlog.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        try {
            ...
            System.out.println("打印错误日志------------" + excepLog.toString());
        } catch (Exception e2) {
            e2.printStackTrace();
        }
