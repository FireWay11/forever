package com.lovezc.forever.util.wechat.login;
...
public class WechatController {
     ...
     * 微信开放平台二维码连接
     */
    private final static String OPEN_QRCODE_URL= "https://open.weixin.qq.com/connect/qrconnect?appid=wx9a9d7dcf7a55a788&redirect_uri=%s&response_type=code&scope=snsapi_login&state=%s#wechat_redirect";
